...
const WHATSAPP_NUMBER = "916398877687";
const WHATSAPP_MESSAGE = encodeURIComponent(
  "Hi VJ Events! I'm interested in booking a destination wedding in Jim Corbett. Could you please share more details about your packages and availability?",
);
