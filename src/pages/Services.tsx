...
const services = [
  ...
  },
  {
    ...
    summary:
      "The baraat is one of the most energetic and memorable parts of any Indian wedding. We arrange a full procession setup — from a decorated ghori or royal baggi to a DJ-loaded Baraat on Wheels truck — complete with a live brass band, dhol players and dancing performers for an entrance that his guests will talk about for years.",
    details: [
      ...
      "Baraat on Wheels — fully decorated DJ truck with booming sound system, LED lights, CO2 guns and confetti cannons that moves with the procession",
      ...
      "Baraat LED lighting with light carriers for evening processions",
      "Decorated palki (palanquin) for the bride's entry if desired",
      "Full timing and route coordination to sync perfectly with the wedding schedule",
    ],
    image: haldiImg,
  },
  {
    ...
    tagline: "A bar your guests will keep coming back to",
    summary:
      "A well-run bar is at the heart of every great cocktail evening and reception. We set up a fully stocked, beautifully designed bar counter with trained bartenders, a custom drinks menu and everything needed to keep your guests happy and the energy high all night — whether it's an intimate gathering or a 500-guest reception.",
    details: [
      "Themed bar counter design — Boho, LED neon, rustic wooden, Bollywood or custom",
      "Full glassware, bar tools, mixers, ice and service equipment provided",
      "Trained professional bartenders and flair mixologists",
      "Custom cocktail menu crafted around your wedding theme and preferences",
      "Welcome drink counters — fresh juices, mocktails and sherbets for all guests",
      "Champagne tower setup and wine service for the reception toast",
      "Alcoholic and non-alcoholic counters run simultaneously",
      "Bar-on-Wheels option — a mobile bar cart that moves through the venue",
      "Sangria bar, gin bar or DIY cocktail station for Sangeet nights",
      "Full setup and teardown handled — no coordination needed from your side",
    ],
    image: cocktailImg,
  },
  {
    ...
    tagline: "Every guest feels like a VIP",
    summary:
      "A great wedding isn't just about the couple — it's about every guest having a smooth, comfortable and memorable experience. Our dedicated hospitality team acts as the single point of contact for all your guests from the moment they arrive in Ramnagar until they check out, so you can focus entirely on enjoying your wedding.",
    details: [
      "Dedicated welcome desk at the resort with personalized check-in assistance",
      "Guest pickup and drop coordination from Ramnagar, Kathgodam and Delhi NCR",
      "Personalised welcome kits — local snacks, wedding itinerary, resort map and gifts",
      "Room allocation, key handover and resort coordination for all guests",
      "Shadow team assigned to both the bride's and groom's families throughout",
      "Meal scheduling, dietary preference tracking and special request handling",
      "24×7 on-call hospitality helpdesk during the full wedding period",
      "Jungle safari, nature walk and activity booking for out-of-town guests",
      "VIP guest protocol — special attention for elders, special needs and senior family",
      "Departure coordination — vehicle booking, checkout assistance and farewell",
    ],
    image: corbettImg,
  },
];
